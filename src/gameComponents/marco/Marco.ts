import IMarco from "./IMarco"; // Questa sezione varia ogni volta
import Hero from "../hero/Hero";
import GamePlay from "../../scenes/GamePlay";
import javascript_state_machine from "javascript-state-machine";
import AnimationCreator from "./AMarco";


// #TODO Testare la classe Player

export default class Marco extends Phaser.GameObjects.Sprite implements IMarco {
    ...
    public movit(chat: Array<{nome:String,dice:String}>,player:Hero) : void {
        ...
        if (!this._animationDone) 
        {
            ...
            for (const t of this._animState.transitions()) {
                ...
                // -- Animazioni --
            this._scene.events.emit("conversazione",chat,"LivelloAereo");
            }
